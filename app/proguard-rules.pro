...
-keep class com.ziek.autoslide.priv.PrivilegeShizukuStartService { *; }
-keep class com.ziek.autoslide.priv.IPrivilegeShizukuStartService { *; }
...
-keep class com.ziek.autoslide.input.AutoSlideInputAction { *; }
