...
function privacyHtml() {
  const dataTable = table(
    ...
    [
      ...
      [
        '使用时长与邀请关系',
        '设备标识（Android ID）、你的邀请码、以及你填写的好友邀请码',
        '<strong>是</strong>，打开应用时查询一次，填写邀请码时提交一次',
        '计算试用期与分享奖励的使用时长，识别刷量行为',
      ],
  ...
  const permTable = table(
    ...
    [
      ...
      ['网络', '可选', '设备信息上报、脚本备份、反馈、检查更新、使用时长校验、出口地址探测'],
  ...
  const body = [
    ...
    section('三、数据的存储与保留', [
      ...
      '本应用会向以下第三方站点发起请求：检查更新时访问 GitHub 获取版本信息。这个请求都不携带 Android ID 等设备标识，'
